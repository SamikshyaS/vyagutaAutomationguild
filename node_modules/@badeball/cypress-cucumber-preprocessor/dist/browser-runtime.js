...
function afterEachHandler(context) {
    ...
    if (remainingSteps.length > 0) {
        if (((_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.state) === "failed") {
            ...
            for (const skippedStep of remainingSteps) {
                const hookIdOrPickleStepId = (0, assertions_1.assertAndReturn)((_l = (_k = skippedStep.hook) === null || _k === void 0 ? void 0 : _k.id) !== null && _l !== void 0 ? _l : (_m = skippedStep.pickleStep) === null || _m === void 0 ? void 0 : _m.id, "Expected a step to either be a hook or a pickleStep");
                const testStepId = getTestStepId({
                    context,
                    pickleId: pickle.id,
                    hookIdOrPickleStepId,
    ...
    const currentRetry = (0, assertions_1.assertAndReturn)((_o = this.currentTest) === null || _o === void 0 ? void 0 : _o._currentRetry, "Expected to find an attribute _currentRetry");
    const retries = (0, assertions_1.assertAndReturn)((_p = this.currentTest) === null || _p === void 0 ? void 0 : _p._retries, "Expected to find an attribute _retries");
    const willBeRetried = ((_q = this.currentTest) === null || _q === void 0 ? void 0 : _q.state) === "failed" ? currentRetry < retries : false;
